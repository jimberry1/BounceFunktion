...
const BounceFBgroup = (props) => {
  return (
    <div className="BounceFBgroup__container">
      <p className="BounceFBgroup__title">Click to go back to our roots</p>
      <div className="BounceFBgroup__playlist">
        <a
        ...
        >
          <Image
            ...
            className="BounceFunktionPlaylist__image"
          />
        </a>
      </div>
    </div>
